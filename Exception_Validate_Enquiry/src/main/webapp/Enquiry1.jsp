...
<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				E-Mail <span id="errorEmail" style="color: red"></span> <input
					type="email" id="email" name="email" class="form-control" /><span
			...
			<div class="g-recaptcha"
				data-sitekey="6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI" id="robot"></div>
	...
	function validate()
	{
		...
		if(name.length>3 && name.length<20 && date !== " " && location !== "--Select--" && mobile.length === 10 && email.length > 3 && email.length <20 &&password.length>5 && password.length<13 && confirmPassword === password && robot === true){
