...
public class AbsentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String inform = req.getParameter("inform");
            ...
            req.setAttribute("Student Name", studentName);
            req.setAttribute("From Date", fromDate);
            req.setAttribute("To Date", toDate);
            req.setAttribute("Reason", reason);
            req.setAttribute("Inform", inform);

            
            req.getRequestDispatcher("AbsentSuccess.jsp").forward(req, resp);
        }
